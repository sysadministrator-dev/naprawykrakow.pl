  ...
  return (
    <>
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-3xl px-4 py-14 text-stone-700">
          <h1 className="text-3xl font-bold text-stone-900">Polityka prywatności</h1>
          <p className="mt-4 text-sm text-stone-500">Ostatnia aktualizacja: wrzesień 2026</p>

          <div className="mt-8 space-y-6 leading-relaxed">
            <section>
              <h2 className="text-xl font-semibold text-stone-900">1. Administrator danych</h2>
              <p className="mt-2">
            ...
            <section>
              <h2 className="text-xl font-semibold text-stone-900">2. Jakie dane zbieramy</h2>
              <p className="mt-2">
            ...
            <section>
              <h2 className="text-xl font-semibold text-stone-900">3. Cel i podstawa przetwarzania</h2>
              <p className="mt-2">
            ...
            <section>
              <h2 className="text-xl font-semibold text-stone-900">4. Okres przechowywania</h2>
              <p className="mt-2">
            ...
            <section>
              <h2 className="text-xl font-semibold text-stone-900">5. Twoje prawa</h2>
              <p className="mt-2">
            ...
            <section>
              <h2 className="text-xl font-semibold text-stone-900">6. Odbiorcy danych</h2>
              <p className="mt-2">
            ...
            <section>
              <h2 className="text-xl font-semibold text-stone-900">7. Pliki cookies</h2>
              <p className="mt-2">

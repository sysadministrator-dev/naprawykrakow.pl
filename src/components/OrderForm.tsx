...
function SubmitButton() {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="w-full rounded-lg bg-primary px-6 py-3 text-base font-semibold text-white transition hover:bg-primary/90 disabled:opacity-60"
    >
  ...
  return (
    <form action={formAction} className="grid gap-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div>
          ...
          <input
            name="name"
            required
            className="w-full rounded-lg border border-zinc-300 px-3 py-2 text-zinc-900 focus:border-primary focus:outline-none"
          />
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div>
          <label className="mb-1 block text-sm font-medium text-zinc-700">Usługa *</label>
          <select
            name="service"
            required
            defaultValue={defaultService ?? ""}
            className="w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 text-zinc-900 focus:border-primary focus:outline-none"
          >
      ...
      <div>
        <label className="mb-1 block text-sm font-medium text-zinc-700">Adres / dzielnica *</label>
        <input
          name="address"
          required
      ...
      <div>
        <label className="mb-1 block text-sm font-medium text-zinc-700">Preferowany termin</label>
        <input
          name="preferredAt"
      ...
      <div>
        <label className="mb-1 block text-sm font-medium text-zinc-700">Opis usterki</label>
        <textarea
          name="message"
          rows={3}
          className="w-full rounded-lg border border-zinc-300 px-3 py-2 text-zinc-900 focus:border-primary focus:outline-none"
